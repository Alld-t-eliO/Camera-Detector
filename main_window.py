...
class LucyGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle(f"◢ LUCY v6.0 - Connected: {self.user_data['username']} ◣")
    ...
    def create_options_panel(self):
        ...
        self.night_mode_cb = QCheckBox("· Night mod")
        ...
        self.trajectories_cb = QCheckBox("· Direction")
    ...
    def start_voice_assistant(self):
        ...
        try:
            ...
            self.voice_status.setText(f"🎤 Assistant vocal: Erreur")
            print(f"⚠️ Vocal Assistant not accessible: {e}")
    
    def handle_voice_command(self, command):
       
        self.alert_text.append(f"<span style='color:#00ff00'>🎤 Command: {command}</span>")
    ...
    def show_system_status(self):
        ...
        msg.setText(f"""
🤖 LUCY v6.0 - System Status

- User: {self.user_data['username']}
- Sécurity: Active (AES-256)
- ML Patterns: {ml_stats['total_patterns']}
- Warnings: {self.alert_count if hasattr(self, 'alert_count') else 0}
- Vocal Assistant: {'Active' if self.voice_assistant and self.voice_assistant.running else 'Inactif'}
- Surveillance: {'Active' if self.is_monitoring else 'Inactive'}
    ...
    def start_monitoring(self):
        ...
        if self.voice_assistant:
            self.voice_assistant.speak("Surveillance activated")
    ...
    def stop_monitoring(self):
        ...
        if self.voice_assistant:
            self.voice_assistant.speak("Surveillance desativated")
    ...
    def add_alert(self, num_persons, timestamp, alert_type, extras):
        ...
        alerts_map = {
            ...
            "MULTIPLE_TARGETS": (f"{num_persons} CIBLES MULTIPLES", "#ffff00"),
        }
        ...
        if 'identities' in extras:
            ...
            self.alert_text.append(f"<span style='color:#00ffff'>👤 Identity: {identities}</span>")
        ...
        self.alert_text.append(f"<span style='color:#00ffff'>🔐 Foto: {os.path.basename(extras.get('encrypted_photo', 'N/A'))}</span>")
        self.alert_text.append("-" * 50)
